exports.config = {
    ...
    specs: [
        //'./test/specs/**/*.js'
        './test/specs/**/cnntestcases.js'
        //'./test/specs/**/Editionpicker.js',
        //'./test/specs/**/headertheme.js',
        //'./test/specs/**/Legallinks.js',
        //'./test/specs/**/Searchcnn.js',
        //'./test/specs/**/Searchcnnpage.js',
        //'./test/specs/**/Subsection.js',
        //'./test/specs/**/videolandingpage.js',
        //'./test/specs/**/weather.js',
        //'./test/specs/**/videospage.js,',
        //'./test/specs/**/pinnedvideo.js'
    ],
    // Patterns to exclude.
    exclude: [
    ...
    /* beforeSuite: function (suite) {
        global.allure = allure;        allure.addFeature(suite.name);  
    ...
    /* afterSession: function (config, capabilities, specs) {
        console.log(`Total Test-'${capabilities.finished}`);
     },*/
    /**
    ...
    /*onComplete: function (exitCode, config, capabilities,  results) {
        ...
        var successes = results.passed;
        var failures = results.failed;
        console.table(successes);
        console.table(failures);
        
        console.log('result of afterstep pass',successes);

        console.log('result of afterstep fail',failures);
        console.log(`Total Test-'${results.finished}`);
